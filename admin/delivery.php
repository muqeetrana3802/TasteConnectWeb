...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="delivery.html" class="menu-item active" data-page="delivery">
    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="dashboard-content">
            <div id="delivery-page">
                ...
                <p class="page-subtitle">Track and manage delivery operations on FoodHub.</p>
