...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="restaurants.html" class="menu-item active" data-page="restaurants">
    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="dashboard-content">
            <div id="restaurants-page">
                ...
                <p class="page-subtitle">View and manage all restaurants on FoodHub.</p>
                                    ...
                                    <td>
                                        <div style="display: flex; align-items: center; gap: 0.75rem;">
                                            ...
                                            <div>
                                                ...
                                                <div style="font-size: 0.8rem; color: var(--medium-gray);">Italian</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>Italian</td>
                                    ...
                                    <td>
                                        <div style="display: flex; align-items: center; gap: 0.75rem;">
                                            ...
                                            <div>
                                                ...
                                                <div style="font-size: 0.8rem; color: var(--medium-gray);">Japanese</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>Japanese</td>
