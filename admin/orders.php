...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="orders.html" class="menu-item active" data-page="orders">
    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="dashboard-content">
            <div id="orders-page">
                ...
                <p class="page-subtitle">View and manage all customer orders on FoodHub.</p>
